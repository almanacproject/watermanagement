...
class TodaysConsumption: UIViewController, FBSDKSharingDelegate {
    ...
    @IBAction func shareConsumption(sender: UIButton) {
        ...
        // let image = UIImage(named: "ThumbFinal_4.9.15.png")
    ...
    func sharerDidCancel(sharer: FBSDKSharing!) {
        print("Facebook - Did cancel")
    }
    
    func sharer(sharer: FBSDKSharing!, didFailWithError error: NSError!) {
        print("Facebook - Failed: \(error.debugDescription)")
    }
    
    func sharer(sharer: FBSDKSharing!, didCompleteWithResults results: [NSObject : AnyObject]!) {
        print("Facebook - Completed: \(results.debugDescription)")
    }
